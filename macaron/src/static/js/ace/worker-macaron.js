...
define("ace/mode/macaron/jshint",[], function(require, exports, module) {
...
var JSHINT = (function() {
  ...
  infix("+", function(left, that) {
    ...
    if (left && right && left.id === "(string)" && right.id === "(string)") {
      ...
      if (!state.option.scripturl && reg.macaronURL.test(left.value)) {
        warning("W050", left);
      }
      return left;
    }
...
var warnings = {
  ...
  W118: "'{a}' is only available in Mozilla Macaron extensions (use moz option).",
  ...
  W129: "'{a}' is defined in a future version of Macaron. Use a " +
...
exports.macaronURL = /^(?:macaron|jscript|ecmascript|vbscript|livescript)\s*:/i;
...
exports.register = function(linter) {
  ...
  linter.on("String", function style_scanMacaronURLs(data) {
    var re = /^(?:macaron|jscript|ecmascript|vbscript|livescript)\s*:/i;
...
define("ace/mode/macaron_worker",[], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var Mirror = require("../worker/mirror").Mirror;
var lint = require("./macaron/jshint").JSHINT;
...
var MacaronWorker = exports.MacaronWorker = function(sender) {
    Mirror.call(this, sender);
    this.setTimeout(500);
    this.setOptions();
};

oop.inherits(MacaronWorker, Mirror);
